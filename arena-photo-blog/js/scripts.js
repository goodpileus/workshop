// original code borrowed from nazli ercan's sky site:
// https://nazli-ercan.com/sky/

let makeURL = (per, page) => `https://api.are.na/v2/channels/i-ugxz85hb2mg?per=${per}&page=${page}`;
